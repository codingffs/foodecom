                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            ...
                            @if (getSetting('topbar_email'))
                                ...
                                <a href="mailto:{{ getSetting('topbar_email') }}" class="text-light d-flex">
        ...
        <div class="gshop-navbar bg-white rounded ps-lg-5 position-relative">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xxl-10 col-xl-9 col-md-9 col-7">
                    ...
                    <div class="home-dropdown position-relative d-none d-xl-block me-5 ">
                        <a href="{{ route('home') }}" class="category-dropdown-btn fw-bold d-none d-sm-inline-block">Home</a>
                    </div>
                        ...
                        <div
                            ...
                            <div class="gshop-header-search dropdown">
                                ...
                                <button type="button" class="header-icon" data-bs-toggle="dropdown">
                                    ...
                                    <svg width="18" height="23" viewBox="0 0 22 23" fill="#39220a"
                            ...
                            <div class="gshop-header-user position-relative">
                                ...
                                <button type="button" class="header-icon">
                                    ...
                                    <svg width="18" height="25" viewBox="0 0 22 25" fill="#39220a"
                                        ...
                                        <path
                                            ...
                                            fill="#39220a" stroke="#39220a" stroke-width="0.2" />
